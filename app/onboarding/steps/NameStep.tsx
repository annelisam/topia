  ...
  return (
    ...
    >
      <input
        ...
        className="w-full bg-transparent border-b-2 border-ink/20 focus:border-ink/60 font-basement font-black text-[clamp(28px,5vw,44px)] uppercase text-ink placeholder:text-ink/15 px-1 py-3 outline-none transition-colors"
        autoComplete="off"
        spellCheck={false}
      />
      {error && (
