                  ...
                  <div className="flex flex-col md:flex-row relative">
                    ...
                    <div className="flex-1 px-3 py-2 md:px-4 md:py-2.5 flex flex-col justify-center relative z-10">
                      <div className="py-1 border-b border-ink/[0.04]">
                        <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">full name</span>
                      ...
                      <div className="py-1 border-b border-ink/[0.04] flex items-center justify-between">
                        <div>
                          <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">handle</span>
                          <span className="font-mono text-[13px] text-ink/60 mt-0.5 block">@{username}</span>
                        </div>
                        <div className="text-right">
                          <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">path</span>
                      ...
                      <div className="py-1 border-b border-ink/[0.04] flex items-center justify-between">
                        <div>
                          <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">issued</span>
                          <span className="font-mono text-[11px] text-ink/40 mt-0.5 block">{memberSince || '—'}</span>
                        </div>
                        <div className="text-right">
                          <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">status</span>
                      ...
                      <div className="py-1 border-b border-ink/[0.04] grid grid-cols-2 gap-x-6">
                        <div>
                          <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">location</span>
                          <span className="font-mono text-[11px] text-ink/40 mt-0.5 block">—</span>
                        </div>
                        {profile.bio && (
                          <div>
                            <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block">declaration</span>
                      ...
                      <div className="py-1 flex items-center justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <span className="font-mono text-[10px] uppercase tracking-[2px] text-ink/50 block mb-1.5">links</span>
                  ...
                  <div className="flex items-center gap-0">
                    {[
                      ...
                      <div key={stat.label} className={`flex flex-col px-3 md:px-5 ${i < arr.length - 1 ? 'border-r border-ink/[0.06]' : ''} ${i === 0 ? 'pl-0' : ''}`}>
                        <span className="font-mono text-[9px] uppercase tracking-[2px] text-ink/20">{stat.label}</span>
