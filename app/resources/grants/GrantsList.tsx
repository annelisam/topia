      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
        ...
        <aside className="w-full lg:w-80 flex-shrink-0">
          <div className="lg:sticky lg:top-6">
            <h2 className="font-mono text-[13px] mb-4 sm:mb-6 uppercase" style={{ color: '#1a1a1a' }}>SEARCH & FILTERS</h2>

            {/* Search */}
            <div className="mb-6 sm:mb-8">
              <label className="block font-mono text-[13px] mb-2 sm:mb-3 uppercase" style={{ color: '#1a1a1a' }}>SEARCH</label>
              <input
                type="text"
            ...
            {/* Filter by Tag */}
            <div className="mb-6 sm:mb-8">
              <label className="block font-mono text-[13px] mb-2 sm:mb-3 uppercase" style={{ color: '#1a1a1a' }}>FILTER BY TAG</label>
            ...
            {/* Sort By */}
            <div>
              <label className="block font-mono text-[13px] mb-2 sm:mb-3 uppercase" style={{ color: '#1a1a1a' }}>SORT BY</label>
              <select
                value={sortBy}
        ...
        <main className="flex-1">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-6 sm:mb-8">
            <h1 className="font-mono text-[13px] uppercase" style={{ color: '#1a1a1a' }}>GRANTS</h1>
            <p className="font-mono text-[13px] uppercase" style={{ color: '#1a1a1a' }}>
          ...
          {loading ? (
            <div className="text-center py-8 sm:py-12">
              <p className="font-mono text-[13px]" style={{ color: '#1a1a1a' }}>Loading grants...</p>
            </div>
          ) : grants.length === 0 ? (
            <div className="text-center py-8 sm:py-12">
              <p className="font-mono text-[13px]" style={{ color: '#1a1a1a' }}>No grants found. Try adjusting your filters.</p>
            </div>
          ) : (
                  ...
                  >
                    <div className="flex justify-between items-start gap-3">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-mono text-[13px] mb-2 uppercase group-hover:underline" style={{ color: '#1a1a1a' }}>
                          {grant.grantName}
                        </h3>
                        {grant.shortDescription && (
                          <p className="font-mono text-[13px] mb-2 sm:mb-3" style={{ color: '#1a1a1a' }}>{grant.shortDescription}</p>
                        )}
                        <p className="font-mono text-[13px] mb-3 sm:mb-4" style={{ color: '#1a1a1a' }}>
                        ...
                        <div className="flex flex-wrap gap-1.5 sm:gap-2">
                          {grant.status && (
                            <span className="px-2.5 sm:px-3 py-0.5 sm:py-1 border font-mono text-[13px] lowercase" style={{ borderColor: '#1a1a1a', color: '#1a1a1a' }}>
                              {grant.status}
                            </span>
                          )}
